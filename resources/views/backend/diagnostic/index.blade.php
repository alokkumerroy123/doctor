...
@section('main')
                            ...
                            <tbody>
                                ...
                                @foreach ($diagnostic as $key => $diagnostics)
                                    <tr>
                                        ...
                                        <td>{{ $diagnostics->division->division_name }}</td>
                                        <td>{{ $diagnostics->district->district_name }}</td>
                                        <td>{{ $diagnostics->upzila->upzila_name }}</td>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu">
                                                    ...
                                                    <a class="dropdown-item" href="javascript:void(0)"
                                                        onclick="editbutton({{ $diagnostics->id }})"><i
                                                            class="fas fa-edit mr-2"></i> Edit</a>
                                                    {{-- @endif --}}

                                                    <a class="dropdown-item text-danger"
                                                        href="{{ route('diagnostic.delete', $diagnostics->id) }}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-success" id="exampleModalLabel">Add Dianostic</h5>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-success" id="exampleModalLabel">Update Diagnostic</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
